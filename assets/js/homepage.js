...
if (homeMapTarget && window.L) {
  ...
  const schools = [
    ...
    { name: 'Royal High School Bath', slug: '/bath/schools/royal-high-school-bath/', lat: 51.397185, lng: -2.365419, type: 'boarding', note: 'Girls · Day & Boarding · Senior campus pin' },
